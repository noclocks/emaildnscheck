...
def _query_dmarc_record(
    ...
    try:
        ...
        dmarc_record = [record for record in records if record.startswith(txt_prefix)][
            0
        ]
...
def get_dmarc_tag_description(
    ...
    if type(value) is str and value in allowed_values:  # noqa: E721
        description = allowed_values[value]
    elif type(value) is list and len(allowed_values):  # noqa: E721
        new_description = ""
